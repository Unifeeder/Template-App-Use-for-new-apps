...
echo "[1/6] Downloading agent skills..."
...
echo ""
echo "[2/6] Downloading design system and documentation template..."
download_file "design.md" "design.md"
download_file "documentation.md" "documentation.md"

echo ""
echo "[3/6] Downloading Pilat font files..."
...
echo ""
echo "[4/6] Downloading DP World logos..."
